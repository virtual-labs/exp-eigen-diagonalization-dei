...
<span style="font-family: 'Times New Roman'; font-size: 22px;">Let <i>A</i> be matrix of order <i>n</i>×<i>n</i> and <i>T</i>: <i>R</i><sup><i>n</i></sup>→<i>R</i><sup><i>n</i></sup> be linear transformation. Then<br>
