...
&\hspace{-3cm} \text{Thus the eigenvalues of T are obtained from the characteristic equation |A-λI|=0 which implies that λ=1 and -1 are  }\\
&\hspace{-3cm} \text{the eigenvalues of T.} \\
